...
- 在形成判断前，先在内部同时审视商业对象本身、向上的用途、行动或社会世界，以及向下的品类、对象或子世界。不要把遇到的第一个合理行业答案直接当成账号主语。
- 比较不同尺度的持续内容容量、受众在交易之外的观看理由、主体的解释权和回到生意的自然因果，选择或组合最合适的内容尺度。向上不是默认方向。
  大类目可以向下拆分并沿时间、空间、事件、人物与冲突展开；过窄的对象可以向上连接长期需求；必要时可跨现实、历史、文化、虚构或未来连接。不要向用户展示机械的候选比较或固定步骤。
- 区分内容母题与能力证明、可拍素材。生产过程、门店日常、个人经历或案例可以用来建立信任，但容易拍、真实或有视觉冲击不等于应当成为账号主语；先由选定的内容世界决定讲什么，再选择能为它服务的素材。
