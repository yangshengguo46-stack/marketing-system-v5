...
DEFAULT_CASES = (
    BrainEvalCase(
        ...
        success_criteria=(
            "把礼品选为最小完整内容根，把黄金保留为材质与价值分支",
            "把送礼、人情往来作为礼品世界的向上连接与长期母题，不因它们更抽象就替换礼品根",
            "把加工能力作为产品承接或信任证明，而不是自动当成账号唯一主语",
            "产品不必每条出现，但内容到黄金礼品生意的归因清楚",
        ),
        failure_modes=(
            "退回黄金工艺展示、厂家获客或B端/C端三套行业模板",
            "把礼品过度抽象成送礼、人情、情绪价值或生活方式并让品类失焦",
    ...
    BrainEvalCase(
        ...
        success_criteria=(
            "把水果选为最小完整内容根，把水果店保留为经营载体",
            "水果世界能沿种类、时间与历史、地域与空间、不同国家和文化群体的饮食习惯、人物事件与冲突持续展开",
            "从水果世界到门店所售水果保持直接商业归因，但不因门店更近成交就把经营过程选成内容根",
        ),
        failure_modes=(
            "把水果压成专业选品、品质避坑或供应链模板",
            "把水果继续空洞抽象成消费世界或生活方式",
            "把产地故事、全国发货或附近客群写成事实",
            "给出一串水果选题，却没有种类、时空、文化、人物和事件构成的长期内容逻辑",
        ),
        review_status="reviewed",
    ),
    BrainEvalCase(
    ...
    BrainEvalCase(
        ...
        business_shape="enabling-product",
        question="我是卖重庆火锅底料的，想做一个账号，内容应该围绕什么展开？只回答当前这个内容世界问题。",
        known_facts=("主体销售重庆火锅底料",),
        material_unknowns=("生产方式", "具体配方与产品差异", "用户结构", "主体可验证的专业经验"),
        success_criteria=(
            "识别底料是商品形态和词法主词，但它直接服务的火锅才是长期内容主语",
            "把重庆保留为地域与风味分支，不用它取代火锅世界",
            "火锅世界能沿种类、时间与历史、地域与空间、民族与不同国家的饮食习惯、人物事件与冲突持续展开",
            "火锅内容与火锅底料之间保持直接的功能和商业归因",
        ),
        failure_modes=(
            "把账号压成底料原料、配方、工艺或购买教育号",
            "把重庆当作唯一根主语，遗漏更大的火锅世界",
            "继续空洞抽象成餐饮体验、生活方式、团圆或情绪价值",
            "把外国、民族或历史饮食细节写成已核验事实，或补造主体的工厂、配方、客户与渠道",
        ),
        review_status="reviewed",
    ),
    BrainEvalCase(
