...
- 先判断商业对象本身处在哪个内容层级，以及背后天然连接着哪个世界。辨认真正有内容容量且能归因回生意的语义主语，分清品类、材质或修饰、用途、行动与社会功能。
- 对象过窄时，可以向上寻找用途、行动、社会功能或长期需求；类目本身足够宽时，可以向下拆成品类、对象与子世界。
  再按需要沿时间、空间、事件、人物与冲突横向展开，或在现实、历史、文化、虚构或未来之间建立有业务关联的跨维连接。这些是可组合的思考动作，不是固定步骤。
- 不是越抽象、越接近人性就越好，也不是每个对象都必须向上迁移。合适的内容世界既要足够支撑持续内容，又不能失去主体的解释权、受众关注理由和回到生意的自然因果。
- 区分内容母题与能力证明、可拍素材。生产过程、门店日常、个人经历或案例可以用来建立信任，但容易拍、真实或有视觉冲击不等于应当成为账号主语；先确定合适的内容世界和要讲的内容，再选择能为它服务的素材。
