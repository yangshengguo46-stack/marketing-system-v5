...
def default_method_cards() -> tuple[MethodCard, ...]:
    ...
    return (
        ...
        MethodCard(
            ...
            search_terms=("定位", "差异", "主体", "人设", "品牌", "产品", "起号策略", "策略"),
        ),
        MethodCard(
        ...
        MethodCard(
            ...
            search_terms=("表现形式", "内容形式", "形式", "表达", "出镜", "口播", "旁白", "拍摄", "隐私"),
        ),
        MethodCard(
        ...
        MethodCard(
            ...
            lens=(
                ...
                "从业年限只支持经验存在，不自动证明拥有可公开案例、客户授权或稳定素材供给",
            ),
            evidence_needs=("日常事件来源", "专业判断过程", "可公开证明"),
            counterexamples=(
                "列出三个空泛内容支柱",
                "依赖无法持续的热点或虚构经历",
                "把尚不存在的客户投稿或团队日常当成现有素材",
                "把从业年限等同于可公开案例和可持续内容资产",
            ),
            source_refs=(
                V4_STRATEGY_SOURCE_ID,
                V4_JUDGMENT_SOURCE_ID,
            ...
            search_terms=("内容", "内容形式", "持续", "更新", "选题", "系列", "发动机", "母题"),
        ),
        MethodCard(
            ...
            search_terms=("变现", "变现闭环", "收入", "付费", "产品", "服务", "赚钱", "商业"),
        ),
        MethodCard(
            ...
            search_terms=("转化", "变现闭环", "闭环", "成交", "私信", "线索", "承接", "复购", "到店"),
        ),
        MethodCard(
            ...
            lens=(
                ...
                "平台指标、受众信号和商业信号分开观察",
                "没有基线时先采集范围，不编造行业阈值",
                "把曝光、互动、合格意向和付费结果分层记录；较低层信号不能证明更高层的付费需求",
            ),
            ...
            search_terms=("实验", "最小实验", "试拍", "首条", "验证", "假设", "复盘", "学习"),
        ),
    )
